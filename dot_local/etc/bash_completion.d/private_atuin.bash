_atuin() {
    ...
    do
        case "${cmd},${i}" in
            ...
            atuin__dotfiles__alias,help)
                ...
                ;;
            atuin__dotfiles__alias,import)
                cmd="atuin__dotfiles__alias__import"
                ;;
            ...
            atuin__dotfiles__alias__help,help)
                ...
                ;;
            atuin__dotfiles__alias__help,import)
                cmd="atuin__dotfiles__alias__help__import"
                ;;
            ...
            atuin__dotfiles__help__alias,delete)
                ...
                ;;
            atuin__dotfiles__help__alias,import)
                cmd="atuin__dotfiles__help__alias__import"
                ;;
            ...
            atuin__help__dotfiles__alias,delete)
                ...
                ;;
            atuin__help__dotfiles__alias,import)
                cmd="atuin__help__dotfiles__alias__import"
                ;;
    ...
    case "${cmd}" in
        atuin)
            opts="-h -V --help --version history import stats search sync login logout register key status account kv store dotfiles init info doctor default-config server uuid contributors gen-completions help"
        ...
        atuin__dotfiles__alias)
            opts="-h --help set delete list import help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__dotfiles__alias__help)
            opts="set delete list import help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__dotfiles__alias__help__help)
            ...
            return 0
            ;;
        atuin__dotfiles__alias__help__import)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        atuin__dotfiles__alias__help__set)
            ...
            return 0
            ;;
        atuin__dotfiles__alias__import)
            opts="-h --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        atuin__dotfiles__help__alias__delete)
            ...
            return 0
            ;;
        atuin__dotfiles__help__alias__import)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        atuin__gen__completions)
            ...
            ;;
        atuin__help)
            opts="history import stats search sync login logout register key status account kv store dotfiles init info doctor default-config server uuid contributors gen-completions help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__help__dotfiles__alias__delete)
            ...
            return 0
            ;;
        atuin__help__dotfiles__alias__import)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 5 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        atuin__help__history__start)
            ...
            ;;
        atuin__help__import)
            opts="auto zsh zsh-hist-db bash resh fish nu nu-hist-db xonsh xonsh-sqlite"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__history__start)
            ...
            ;;
        atuin__import)
            opts="-h --help auto zsh zsh-hist-db bash resh fish nu nu-hist-db xonsh xonsh-sqlite help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        atuin__import__fish)
            ...
            ;;
        atuin__import__help)
            opts="auto zsh zsh-hist-db bash resh fish nu nu-hist-db xonsh xonsh-sqlite help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
